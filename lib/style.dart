...
Widget mainButtonStyle(int color, String title){
  ...
  return Container(//botoes da homepage
...
Widget algorithmPageStyle(List<String> _image, File _originalImage, String title, String algorithm){
  return Scaffold(
      ...
      body: Container(
          margin: EdgeInsets.only(left:15.0,top:10.0,right:15.0,bottom: 5.0),
